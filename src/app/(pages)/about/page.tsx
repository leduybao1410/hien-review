...
export default async function AboutPage() {
    ...
    return (
        <div className="container flex flex-col md:flex-row gap-4 mx-auto px-4 py-12 bg-white rounded-lg shadow-xl my-12">
            <div className="lg:w-1/2 md:w-full flex flex-col gap-4 md:border-r-2 border-[#777] pr-4 pl-4">
                <h1 className="md:text-3xl text-2xl font-bold text-center text-white bg-[var(--inverse-primary-color)] px-4 py-2 w-fit mx-auto rounded-full">Về Hiển Review</h1>
            ...
            <div className="lg:w-1/2 md:w-full flex flex-col gap-4 pr-4 pl-4">
                <div className="w-full flex flex-col items-center justify-center">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-lg font-bold text-gray-800">Kênh Youtube: <Link className="text-red-500" href="https://www.youtube.com/@Hien_review">Hiển Review</Link></p>
                        <p className="text-lg font-bold text-gray-800">Facebook: <Link className="text-blue-500" href="https://www.facebook.com/HienReviewTechAudio">Hiển Review Fanpage</Link></p>
                        <p className="text-lg font-bold text-gray-800">Gmail: <Link className="text-green-500" href="mailto:hienreviewer@gmail.com">hienreviewer@gmail.com</Link></p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <div className="mt-8">
                            ...
                            <div className="flex flex-col items-center">
                                <iframe className="md:w-[500px] md:h-[315px] w-[300px] h-[170px]" src={createIframeLink(latestVideo?.youtubeId ?? '')} title={latestVideo?.youtubeTitle ?? ''} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
